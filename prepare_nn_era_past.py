...
pcs = xarray.open_dataset('pcs_era5.h5')["pcs"].values.T
...
xarray.DataArray(x_new).to_netcdf("x_training_past_era.nc")
xarray.DataArray(pcs_new).to_netcdf("pcs_training_past_era.nc")
